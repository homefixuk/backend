var app = angular.module('homefixLoginApp', ['ngStorage', 'angular-jwt']);
app.config(function ($interpolateProvider) {
    $interpolateProvider.startSymbol('{[{').endSymbol('}]}');
});
app.controller('homefixLoginController', function Controller($scope, $http, $location, $localStorage, jwtHelper, $window) {
    $scope.message = '';

    $scope.controllerLogin = function () {
        $http.post('/user/login', {
            apikey:'2fd2e24f60ba0969e67cab0e338b3ac9',
            email: $scope.email,
